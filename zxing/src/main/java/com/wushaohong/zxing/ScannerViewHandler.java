...
import com.wushaohong.zxing.decode.DecodeThread;
...
final class ScannerViewHandler extends Handler {
    ...
    public interface HandleDecodeListener {
        ...
        void checkWeakLight(boolean isWeakLight);
    }
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case Scanner.LAUNCH_PRODUCT_QUERY:
                break;
            case Scanner.WEAK_LIGHT:
                handleDecodeListener.checkWeakLight((Boolean) message.obj);
                break;
        }
    }
    ...
    public void quitSynchronously() {
        ...
        removeMessages(Scanner.WEAK_LIGHT);
    }
