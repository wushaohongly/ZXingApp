...
public class ScannerView extends RelativeLayout {
    ...
    void handleWeakLight(boolean isWeakLight) {
        if (mScannerCompletionListener != null) {
            mScannerCompletionListener.onCheckWeakLight(isWeakLight);
        }
    }
    ...
    public boolean isLightStatus() {
        return mSurfaceView.isLightMode();
    }
     ...
     * @return
     */
    public ScannerView setResultZoom(boolean b) {
        mScannerOptionsBuilder.setResultZoom(b);
        return this;
    }
     ...
     * @return
     */
    public ScannerView setResultZoomReset(boolean b) {
        mScannerOptionsBuilder.setResultZoomReset(b);
        return this;
    }
     ...
     * @return
     */
    public ScannerView setResultZoomResetDelay(long ms) {
        mScannerOptionsBuilder.setResultZoomResetDelay(ms);
        return this;
    }
}
